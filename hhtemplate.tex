...
{ % long and thesis
  \fancypagestyle{hh-template-abstract-header-footer}{
    ...
    \renewcommand{\headrulewidth}{0cm}
    \renewcommand{\footrulewidth}{0cm}
    \lhead{\textbf{{\large \translate{abstract}}}}
  }
...
\ifthenelse{\equal{\hhtemplatetype}{long}\OR\equal{\hhtemplatetype}{thesis}}{
  \begin{titlepage}
    \newgeometry{top=2cm, bottom=1cm, left=2cm, right=2cm, includehead=false, includefoot=false}
...
\ifthenelse{\equal{\hhtemplatetype}{thesis}}{
  ...
  \vspace{-1pt}\fbox{\begin{minipage}[l][2.5em][t]{\textwidth}\textbf{\translate{thesisname}}\\\hhdocumenttitle\end{minipage}}
  \vspace{-1pt}\fbox{\begin{minipage}[l][2.5em][t]{\textwidth}\textbf{\translate{pageandappendicescount}}\\ \hhdocumentpagecount\ + \hhdocumentnumberofappendices\end{minipage}}
  \vspace{-1pt}\fbox{\begin{minipage}[l][13cm][t]{\textwidth}\setlength{\parskip}{1em}$abstract$\end{minipage}}
